...
## 今回のハンズオンについて
レポジトリ(ghcr.io/nginxinc/nginx-unprivileged)にあるNginxのバージョン(初期インストールされるバージョン:1.29.0)を  
ArgoCD Image Updaterにて監視することで、レジストリの1.29.x台の最新Latest版へ更新するハンズオンとしています。  
